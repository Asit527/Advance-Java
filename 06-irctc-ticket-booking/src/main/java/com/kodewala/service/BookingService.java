...
import com.kodewala.exception.InSufficentBalanceException;
import com.kodewala.payment.entity.PaymentEntity;
import com.kodewala.payment.repository.PaymentRepo;
import com.kodewala.repository.BookingRepository;
...
public class BookingService {
	...
	public BookingResponse doBooking(BookingRequest bookingRequest) {
		...
		} catch (Exception e)
		{
			...
			e.printStackTrace();
			throw new InSufficentBalanceException("User does not have enough balance to book ticket.");
		}
